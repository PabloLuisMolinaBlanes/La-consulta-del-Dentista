...
response.sendRedirect(redirectURL);
               ...
               if(result.next()) {
                   ...
                   if (request.getParameter("iamthemagicbutton").equals("yesmakeit")) {
                    PreparedStatement modify = con.prepareStatement("INSERT INTO Usuario (username, email, password, userID) VALUES (?, ?, ?, ?)"); 
                    ...
                    if (request.getParameter("pk").equals("")) {
                        modify.setString(4, null);
                    } else {
                        modify.setString(4, request.getParameter("pk"));
                    }
                    modify.execute();
                    out.println("<p>Your information has been added succesfully!</p>");
                   } else {
                   }
               }
         ...
         con.close();%>
        <form action="chooseDBAddUsuarioMain.jsp" method="POST">
        ...
        <%  
            ...
            out.println("<form action='chooseDBAddUsuarioMain.jsp' method='POST'>");   
            out.println("<tr>" + "<br>" + "<td>" + "<input type='" + "text" + "' value='"  + username + "' name='" + "username'" + ">" + "</td>" + "<td>" + "<input type='" + "text" + "' value='"  + email + "' name='" + "email'" + ">" + "</td>" + "<td>" + "<input type='" + "password" + "' value='"  + users.getString("password") + "' name='" + "password'" + ">" + "</td>" + "<td>" + "<input type='" + "text" + "' value='"  + users.getString("dateOfCreation") + "' name='" + "dateOfCreation'" + ">" + "</td>" + "<td>" + users.getString("userID"));    
            ...
            out.println("<form action='chooseDBAddUsuarioMain.jsp' method='POST'>");   
            out.println("<tr>" + "<br>" + "<td>" + "<input type='" + "text" + "' value='"  + "' name='" + "username'" + ">" + "</td>" + "<td>" + "<input type='" + "text" + "' value='"  +  "' name='" + "email'" + ">" + "</td>" + "<td>" + "<input type='" + "password" + "' value='"  + "' name='" + "password'" + ">" + "</td>" + "<td>" +  "<input type='" + "text" + "' value='"  + "' name='" + "dateOfCreation'" + ">" + "</td>" + "<td>" + "<input type='" + "text" + "' value='"  + "' name='" + "pk'" + ">" + "</td>" + "<td>" + "<input type='submit' name='iamthemagicbutton' value='yesmakeit' onclick='setter(" + counter + ")'>" + "</td>" + "</tr>");    
            out.println("<input type='hidden' name='row' value='" + counter + "'>");
            out.println("<input type='hidden' class='root' name='rootpassword' value='" + counter + "'>");
            out.println("</form>");
            out.println("</table>");
            out.println("<br><br>");
