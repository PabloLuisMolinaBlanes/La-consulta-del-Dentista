...
response.sendRedirect(redirectURL);
               ...
               if(result.next()) {
                   ...
                   if (request.getParameter("iamthemagicbutton").equals("yesmakeit")) {
                    PreparedStatement modify = con.prepareStatement("DELETE FROM usuario WHERE userID = ?"); 
                    modify.setString(1, request.getParameter("row"));
                    modify.execute();
                    out.println("<p>Your information has been deleted succesfully!</p>");
                   } else {
                   }
               }
         ...
         con.close();%>
        <form action="chooseDBDeleteUsuarioMain.jsp" method="POST">
        ...
        <%  
            ...
            out.println("<form action='chooseDBDeleteUsuarioMain.jsp' method='POST'>");   
